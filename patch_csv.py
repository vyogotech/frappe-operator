...
with open('config/manifests/bases/frappe-operator.clusterserviceversion.yaml') as f:
...
with open('config/manifests/bases/frappe-operator.clusterserviceversion.yaml', 'w') as f:
