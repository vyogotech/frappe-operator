...
func (p *PostgresProvider) ensureSharedPostgres(ctx context.Context, site *vyogotechv1alpha1.FrappeSite, dbName, dbUser string) (string, string, error) {
...
func (p *PostgresProvider) ensureDedicatedPostgres(ctx context.Context, site *vyogotechv1alpha1.FrappeSite, dbName, dbUser string) (string, string, error) {
	clusterName := fmt.Sprintf("%s-postgres", site.Name)
...
func (p *PostgresProvider) getSharedHostPort(ctx context.Context, site *vyogotechv1alpha1.FrappeSite) (string, string, error) {
...
func (p *PostgresProvider) generateDBName(site *vyogotechv1alpha1.FrappeSite) string {
...
func (p *PostgresProvider) generateDBUser(site *vyogotechv1alpha1.FrappeSite) string {
