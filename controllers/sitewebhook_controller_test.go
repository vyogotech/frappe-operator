...
func TestSiteWebhookReconciler_Reconcile(t *testing.T) {
	...
	webhook := &vyogotechv1.SiteWebhook{
		...
		Spec: vyogotechv1.SiteWebhookSpec{
			SiteRef: &vyogotechv1.NamespacedName{
				Name: "test-site",
			},
			WebhookDocType: "Sales Order",
			WebhookEvent:   "on_submit",
	...
	updated := &vyogotechv1.SiteWebhook{}
