...
func (in *FrappeBenchSpec) DeepCopyInto(out *FrappeBenchSpec) {
	*out = *in
	...
	if in.GunicornAutoscaling != nil {
		in, out := &in.GunicornAutoscaling, &out.GunicornAutoscaling
		*out = new(HPAConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.SocketIOAutoscaling != nil {
		in, out := &in.SocketIOAutoscaling, &out.SocketIOAutoscaling
		*out = new(HPAConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.NginxAutoscaling != nil {
		in, out := &in.NginxAutoscaling, &out.NginxAutoscaling
		*out = new(HPAConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Security != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerAutoscalingConfig) DeepCopyInto(out *WorkerAutoscalingConfig) {
	*out = *in
	if in.Short != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerAutoscalingConfig.
func (in *WorkerAutoscalingConfig) DeepCopy() *WorkerAutoscalingConfig {
	if in == nil {
		return nil
	}
	out := new(WorkerAutoscalingConfig)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerScalingStatus.
func (in *WorkerScalingStatus) DeepCopy() *WorkerScalingStatus {
	if in == nil {
		return nil
	}
	out := new(WorkerScalingStatus)
	in.DeepCopyInto(out)
	return out
}
